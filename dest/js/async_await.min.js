...
var ajax_1 = function ajax_1() {
  ...
  return new Promise(function (resolve, reject) {fetch('https://cnodejs.org/api/v1/topics', { // 在URL中写上传递的参数
    ...
    }).then(function (res) {console.log("获取ajax_2数据成功了");resolve(res);}).catch(function (res) {reject("获取ajax_2数据失败了");});});};async function twoAjax() {var res_1 = await ajax_1();var res_2 = await ajax_2();console.log("获取的两个ajax的数据");console.log([res_1, res_2]);}console.log("---async_await demo---");twoAjax();
