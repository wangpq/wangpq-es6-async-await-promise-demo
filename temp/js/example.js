...
async function twoAjax() {
  var res_1 = await ajax_1();
  var res_2 = await ajax_2();
...
Dog = function (_Animal) {_inherits(Dog, _Animal);
  function Dog(name, color) {_classCallCheck(this, Dog);
    console.log("==constructor dog");var _this = _possibleConstructorReturn(this, (Dog.__proto__ || Object.getPrototypeOf(Dog)).call(this));

    _this.name = name;
    _this.color = color;
    _this.variety = "犬科";return _this;
  }_createClass(Dog, [{ key: "sayHello", value: function sayHello()
    {
...
document.getElementById("btnAdd").onclick = function () {
  var v1 = document.getElementById("addOne").value;
  var v2 = document.getElementById("addTwo").value;
  if (!isNaN(v1) && !isNaN(v2)) {
    (0, _jquery2.default)("#demo_2").html(_utils.GztUtils.add(parseInt(v1), parseInt(v2)));
  } else {
    (0, _jquery2.default)("#demo_2").html("输入数据格式有误");
  }
};

document.getElementById("circle").onkeyup = function () {
  document.getElementById("demo_3").innerHTML = new _utils.Circle(parseInt(this.value)).getArea().toFixed(2);
};
...
"use strict";var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}var Animal = function () {
  ...
  }_createClass(Animal, [{ key: "say", value: function say()
    {
